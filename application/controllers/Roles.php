...
class Roles extends MY_Controller {
    ...
    public function role_list()
     {
		...
		$data = array();
          ...
          foreach($role->result() as $r) {
            ...
            $option.='<span data-toggle="tooltip" data-placement="top" title="Edit"><button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"  data-bs-toggle="modal" data-bs-target=".edit-modal-data"  data-role_id="'. $r->role_id . '"><i class="fas fa-edit"></i></button></span>';
            }
            if(in_array('20',$role_resources_ids)) {
            $option.='<span data-toggle="tooltip" data-placement="top" title="Delete"><button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 delete" data-bs-toggle="modal" data-bs-target=".delete-modal" data-record-id="'. $r->role_id . '"><i class="fas fa-trash"></i></button></span>';
            }
	...
	public function update() {
		...
		$role_resources = '';
		if(!empty($this->input->post('role_resources'))){
		    $role_resources = implode(',',$this->input->post('role_resources'));
		}
