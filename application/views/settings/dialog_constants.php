...
<?php }else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='doc_type' && $_GET['type']=='doc_type'){
    $row = $this->Xin_model->read_doc_type_data_by_id($_GET['field_id']);
    ?>
    <!--begin::Modal content-->
    <div class="modal-content">
        <!--begin::Modal header-->
        ...
        <div class="modal-body py-lg-10 px-lg-10">
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid">
                <div class="flex-row-fluid py-lg-12 px-lg-15">
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="<?php echo site_url("settings/update_doc_type") ?>/<?php echo $row[0]->id;?>" method="post" id="update_doc_type">
                        <div class="current" data-kt-stepper-element="content">
                            <div class="w-100">
                                <div class="fv-row mb-10 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="name" placeholder="Document Type" value="<?php echo $row[0]->name;?>">
                                    <br>
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                        <span class="required">Code</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" aria-label="Specify your unique app name" data-kt-initialized="1"></i>
                                    </label>
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="code" placeholder="Code" value="<?php echo $row[0]->code;?>">
                                </div>
                            </div>
                            <div class="d-flex flex-stack pt-10">
                                <div class="me-2">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var xin_table_doc_type = $('#xin_table_doc_type').dataTable({
                ...
                "aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
                "ajax": {
                    url : "<?php echo site_url("settings/doc_type_list") ?>",
                    type : 'GET'
                },
                "fnDrawCallback": function(settings){
                    $('[data-toggle="tooltip"]').tooltip();
            ...
            /* Edit data */
            $("#update_doc_type").submit(function(e){
                /*Form Submit*/
                e.preventDefault();
                var obj = $(this), action = obj.attr('name');
                $('.save').prop('disabled', true);
                $.ajax({
                    type: "POST",
                    url: e.target.action,
                    data: obj.serialize()+"&is_ajax=21&type=doc_type&data=doc_type&form="+action,
                    cache: false,
                    success: function (JSON) {
                        if (JSON.error != '') {
                            toastr.error(JSON.error);
                            ...
                            $('.edit_setting_datail').modal('toggle');
                            xin_table_doc_type.api().ajax.reload(function(){
                                toastr.success(JSON.result);
                            }, true);
                            $('.save').prop('disabled', false);
                        }
...
<?php }else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='store' && $_GET['type']=='store'){
    $row = $this->Xin_model->read_store_data_by_id($_GET['field_id']);
    ?>
    <!--begin::Modal content-->
    <div class="modal-content">
        <!--begin::Modal header-->
        ...
        <div class="modal-body py-lg-10 px-lg-10">
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid">
                <div class="flex-row-fluid py-lg-12 px-lg-15">
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="<?php echo site_url("settings/update_store") ?>/<?php echo $row[0]->id;?>" method="post" id="update_store">
                        <div class="current" data-kt-stepper-element="content">
                            <div class="w-100">
                                <div class="fv-row mb-10 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="name" placeholder="Store" value="<?php echo $row[0]->name;?>">
                                    <br>
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                        <span class="required">Store Code</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" aria-label="Specify your unique app name" data-kt-initialized="1"></i>
                                    </label>
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="code" placeholder="Store" value="<?php echo $row[0]->code;?>">
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                    ...
                                    <select name="currency" class="form-select  form-select-solid" data-placeholder="Select Currency" data-allow-clear="true" data-hide-search="true">
                                        ...
                                        foreach($currency_data->result() as $currencies) {
                                            ?>
                                            <option value="<?php echo $currencies->code?>"<?php if($row[0]->currency==$currencies->code) echo 'selected';?>><?php echo $currencies->code?></option>
                                        <?php }
                                        ?>
                                    </select>						<label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                        <span class="required">Latitude</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" aria-label="Specify your unique app name" data-kt-initialized="1"></i>
                                    </label>
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="latitude" placeholder="Latitude" value="<?php echo $row[0]->latitude;?>">
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                        <span class="required">Longitude</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" aria-label="Specify your unique app name" data-kt-initialized="1"></i>
                                    </label>
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="longitude" placeholder="Longitude" value="<?php echo $row[0]->longitude;?>">
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                        <span class="required">Address</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" aria-label="Specify your unique app name" data-kt-initialized="1"></i>
                                    </label>
                                    <textarea  class="form-control form-control-lg form-control-solid" name="address" placeholder="Address"><?php echo $row[0]->address;?></textarea>
                                </div>
                            </div>
                            <div class="d-flex flex-stack pt-10">
                                <div class="me-2">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var xin_table_store = $('#xin_table_store').dataTable({
                ...
                "aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
                "ajax": {
                    url : "<?php echo site_url("settings/store_list") ?>",
                    type : 'GET'
                },
                "fnDrawCallback": function(settings){
                    $('[data-toggle="tooltip"]').tooltip();
            ...
            $("#update_store").submit(function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: e.target.action,
                    data: obj.serialize()+"&is_ajax=21&type=store&data=store&form="+action,
                    cache: false,
                    success: function (JSON) {
                        if (JSON.error != '') {
                            toastr.error(JSON.error);
                            ...
                            $('.edit_setting_datail').modal('toggle');
                            xin_table_store.api().ajax.reload(function(){
                                toastr.success(JSON.result);
                            }, true);
                            $('.save').prop('disabled', false);
                        }
...
<?php }else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='period' && $_GET['type']=='period'){
    $row = $this->Xin_model->read_periods_data_by_id($_GET['field_id']);
    ?>
    <div class="modal-content">
        <div class="modal-header">
            <h2>Edit Period</h2>
        ...
        <div class="modal-body py-lg-10 px-lg-10">
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid">
                <div class="flex-row-fluid py-lg-12 px-lg-15">
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="<?php echo site_url("settings/update_period") ?>/<?php echo $row[0]->id;?>" method="post" id="update_period">
                        <div class="current" data-kt-stepper-element="content">
                            <div class="w-100">
                                <div class="fv-row mb-10 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                    <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                    ...
                                    <input type="text" id="reportrange1" name="range" class='form-control form-select-solid'>
                                    ...
                                    <select class="form-control form-select form-control-solid mb-3 mb-lg-0" name="category">
                                        ...
                                        foreach($categories->result() as $r){?>
                                            <option value="<?php echo $r->id?>" <?php if($r->id==$row[0]->category_id) echo "selected";?>><?php echo $r->name?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#reportrange1').daterangepicker({
                startDate:  "<?php echo $row[0]->from_date; ?>",
                endDate: "<?php echo $row[0]->to_date; ?>",
                locale: {
                    format: 'D MMM YYYY'
                },
                "showDropdowns": true,
            ...
            var xin_table_periods = $('#xin_table_periods').dataTable({
                ...
                "aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
                "ajax": {
                    url: "<?php echo site_url("settings/period_list") ?>",
                    type: 'GET'
                },
                "fnDrawCallback": function (settings) {
                    $('[data-toggle="tooltip"]').tooltip();
            ...
            /* Edit data */
            $("#update_period").submit(function (e) {
                /*Form Submit*/
                e.preventDefault();
                var obj = $(this), action = obj.attr('name');
                $('.save').prop('disabled', true);
                $.ajax({
                    type: "POST",
                    url: e.target.action,
                    data: obj.serialize() + "&is_ajax=21&type=edit_period&data=edit_period&form=" + action,
                    cache: false,
                    success: function (JSON) {
                        if (JSON.error != '') {
                            toastr.error(JSON.error);
                            ...
                            $('.edit_setting_datail').modal('toggle');
                            xin_table_periods.api().ajax.reload(function () {
                                toastr.success(JSON.result);
                            }, true);
                            $('.save').prop('disabled', false);
                        }
