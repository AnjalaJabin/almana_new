...
if(empty($all_sub_categories->result()))
{
    ?>
    <input type="hidden" name="no_data" id="no_data" value="1">
...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Add New Request</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
    </div>
        ...
        <div class="row g-6 g-xl-9">
            ...
            <div class="col-lg-12">
                <div class="card card-flush p-8">
                    <!--begin:Form-->
                    <form id="add_request_form" class="form" action="#">
                        <!--begin::Heading-->
                        ...
                        <!--begin::Input group-->
                        <div class="col-md-4 fv-row" style="display:block !important;">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Request Title</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a target name for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Request Title" name="expense_type" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Col-->
                        ...
                        <div class="row g-3 mb-8">
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Amount" id="current_request_amount" name="amount" />
                            </div>
                            <!--end::Col-->
                            <div class="col-md-2 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select Currency" id="currency" name="currency">
                                    ...
                                    foreach($currency_data->result() as $currencies) {
                                        echo '<option value="'.$currencies->code.'">'.$currencies->code.'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="row g-3 mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" id="total_spent_subcat" placeholder="Sub Category Expense" name="total_spent_subcat" style="color:#8f3938 ; font-size: 16px; font-weight: bold;" />
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-4 fv-row">
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" name="remarks" placeholder="Free field to describe the request"></textarea>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Actions-->
