                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 align-middle">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-1">
                                                <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3"><?php echo $budget_details_info[0]->budget_name; ?> (AED)</a>
                                ...
                                <div class="d-flex mb-4 mt-4">
                                    ...
                                    <a href="<?php echo site_url('budgeting/add_expense/'.$budget_details_info[0]->id); ?>" class="btn btn-sm btn-primary me-3">Add Expense</a>
                            ...
                            <div class="col-md-6">
                                <table class="table table-row-dashed table-row-gray-300 align-middle">
                                    ...
                                    <tr class="fw-bolder text-muted ">
                                        <th class="text-end ">Category Spend</th>
                                    ...
                                    <tr class="px-3">
                                        <th class="text-end text-dark fw-bolder fs-4 px-3">Total :</th>
        ...
        <div class="row g-6 g-xl-9">
            ...
            <div class="col-lg-12">
                <div class="card card-flush p-8">
                    <!--begin:Form-->
                    <form id="edit_request_form" class="form" action="#">
                        <!--begin::Heading-->
                        ...
                        <div class="row g-3 mb-8">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Expense Title" name="expense_type" value="<?php echo $request_data->expense_type; ?>"/>
                        </div>
                            <!--begin::Col-->
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" id="sub_category_change" data-hide-search="true" data-placeholder="Select Categories" name="sub_category_id">
                                    ...
                                    foreach($all_sub_categories->result() as $sub_categories){
                                        ?>
                                        <option <?php if($request_data->sub_cat_id==$sub_categories->id){ echo 'selected'; } ?> data-main_cat_id="<?php echo $sub_categories->main_cat_id; ?>" value="<?php echo $sub_categories->id; ?>"><?php echo $sub_categories->name; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12 datepicker" placeholder="Select a date" name="date" value="<?php echo date('d-m-Y',strtotime($request_data->requested_date)); ?>"/>
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            </div>
                        ...
                        <div class="row g-3 mb-8">
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Amount" id="current_request_amount" name="amount" value="<?php echo round($request_data->requested_amount,2); ?>"/>
                            </div>
                            <!--end::Col-->
                            <div class="col-md-2 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Currency" id="currency" name="currency">
                                    ...
                                    foreach($currency_data->result() as $currency){
                                        ?>
                                        <option <?php if($request_data->currency==$currency->code){ echo 'selected'; } ?> value="<?php echo $currency->code; ?>"><?php echo $currency->code; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <!--begin::Col-->
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-bold mb-2">  Sub-Category Total  </label>
                                <input type="text" class="form-control form-control-solid" placeholder=" Sub-Category Total" id="category_total" style="color: green; font-size: 16px; font-weight: bold;"/>
                            </div>
                            <!--end::Col-->
                        ...
                        <div class="row g-3 mb-8">
                            ...
                            <!--begin::Col-->
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-bold mb-2">  Available amount in sub-category </label>
                                <input type="text" class="form-control form-control-solid" id="sub_cat_balance" placeholder="Available amount" name="sub_cat_balance" style="color: green; font-size: 16px; font-weight: bold;" />
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-bold mb-2"> Total Expense in Sub-category </label>
                                <input type="text" class="form-control form-control-solid" id="total_spent_subcat" placeholder="Sub Cat expense" name="total_spent_subcat" style="color:#8f3938 ; font-size: 16px; font-weight: bold;" />
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-bold mb-2">Total spent by user </label>
                                <input type="text" class="form-control form-control-solid" id="amount_used" placeholder="Total Spent" name="amount_used" style="color: #8f3938; font-size: 16px; font-weight: bold;" />
                            </div>
                            <!--end::Col-->
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" name="remarks" placeholder="Free field to describe the description of the expense"><?php echo $request_data->remarks; ?></textarea>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Actions-->
