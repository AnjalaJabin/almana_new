	...
	<div id="kt_content_container" class="container-xxl">
										...
										<div class="d-flex flex-wrap">
											...
											<div class="border border-primary border-solid rounded min-w-125px py-3 px-4 me-6 mb-3">
												...
												<div class="d-flex align-items-center">
													<div class="fs-4 fw-bolder text-primary"><?php echo number_format($budget_details_info[0]->amount); ?></div>
												</div>
												<!--end::Number-->
												<!--begin::Label-->
									...
									<div class="d-flex flex-wrap align-middle">
										...
										<div class="d-flex flex-wrap">
											...
											<label class="d-flex align-items-center fs-6 fw-bold mb-2">
												<span class="required">Approval Document</span>
											</label>
											<?php
											$file_required = 'required="true"';
											if(!empty($budget_details_info[0]->budget_document)){
											    $file_required = '';
											}
											?>
											<input type="file" class="form-control form-control-solid" name="budget_document" <?php echo $file_required; ?>/>
											<?php
											if(!empty($budget_details_info[0]->budget_document)){
											    ?>
											    <input type="hidden" name="budget_file_name" value="<?php echo $budget_details_info[0]->budget_document; ?>"/>
            									<a class="symbol symbol-20px mb-5" target="blank" href="<?php echo site_url('uploads/budget_files/'.$budget_details_info[0]->budget_document); ?>"><i class="fa fa-file"></i> View Uploaded Document</a>
            									<?php
											}
											?>
											<!--end::Stat-->
								...
								<div class="flex-grow-1">
									...
									<div class="d-flex flex-column justify-content-center flex-row-fluid pe-11 mb-5">
										...
										<div class="d-flex fs-6 fw-bold align-items-center mb-3">
											...
											<div class="ms-auto fw-bolder text-gray-700"><?php echo number_format($budget_details_info[0]->amount); ?></div>
										</div>
										<!--end::Label-->
									</div>
									<!--end::Labels-->
		...
		<div class="card card-flush">
			...
			<div class="d-flex flex-stack flex-wrap px-10 py-10 border-top">
				...
				<!-- end::Actions-->
				<!-- begin::Action-->
				<button type="submit" class="btn btn-primary my-1">Submit and Approve</button>
				<!-- end::Action-->
			</div>
			<!-- end::Footer-->
		</div>
