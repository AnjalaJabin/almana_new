...
foreach($query->result() as $expense_data_1){
    $grand_tot=$grand_tot+$expense_data_1->amount;
...
<div class="toolbar" id="kt_toolbar">
	...
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
		...
		<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
			<!--begin::Title-->
			<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Expense</h1>
			<!--end::Title-->
		</div>
		<!--end::Page title-->
	</div>
						...
						<div class="row">
							...
							<div class="col-md-6 align-middle">
										...
										<div class="d-flex flex-wrap">
											...
											<div class="border border-primary border-solid rounded min-w-125px py-3 px-4 me-6 mb-3">
												...
												<div class="d-flex align-items-center">
													<div class="text-end fs-4 fw-bolder text-primary"><?php echo number_format($budget_details_info[0]->amount,2); ?></div>
												</div>
												<!--end::Number-->
												<!--begin::Label-->
											...
											<div class="border border-warning border-solid rounded min-w-125px py-3 px-4 me-6 mb-3">
												<!--begin::Number-->
												<div class="d-flex align-items-center">
													<div class="text-end fs-4 fw-bolder text-warning"><?php echo number_format($grand_tot,2); ?></div>
												</div>
												<!--end::Number-->
												<!--begin::Label-->
											...
											<div class="border border-success border-solid rounded min-w-125px py-3 px-4 me-6 mb-3">
												<!--begin::Number-->
												<div class="d-flex align-items-center">
													<div class="text-end fs-4 fw-bolder text-success"><?php echo number_format($budget_details_info[0]->amount-$grand_tot,2); ?></div>
												</div>
												<!--end::Number-->
												<!--begin::Label-->
								...
								<div class="d-flex mb-4 mt-4">
									<a href="#" class="btn btn-sm btn-bg-light btn-active-color-primary me-3">Export Report</a>
									<a href="add-expense.php" class="btn btn-sm btn-primary me-3">Edit Expense</a>
								</div>
							</div>
							<div class="col-md-6">
								<table class="table table-row-dashed table-row-gray-300 align-middle">
									...
									<tbody>
            							...
            							foreach($assigned_budget_category->result() as $assigned_budget_category_data)
            							{
                                    	    ...
                                    	    foreach($query->result() as $expense_dat){
                                    	        $cat_total=$cat_total+$expense_dat  ->amount;
                                    	    }
				...
				<div class="card card-flush p-8">
					...
					<form id="add_expense_form" class="form" action="#">
						...
						<div class="mb-13 text-left">
                            ...
                            <!--begin::Title-->
							<h1 class="mb-3">Edit Expense Record</h1>
							<!--end::Title-->
						</div>
						<!--end::Heading-->
						<!--begin::Input group-->
						<div class="d-flex flex-column mb-8 fv-row" style="display:none !important;">
							...
							<!--end::Label-->
							<input type="text" class="form-control form-control-solid" placeholder="Expense Title" name="expense_title" value="<?php echo $expense_data[0]->exp_title; ?>"/>
						</div>
						<!--end::Input group-->
						<!--begin::Input group-->
						<div class="row g-3 mb-8">
                            <div class="col-md-2 fv-row">
                                <label class="required fs-6 fw-bold mb-2">Entity</label>
                                <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Company" id="company" name="company">
                                    <option value="">Select Entity...</option>
                                    <?php

                                    $comp_data = $this->Xin_model->get_companies();
                                    foreach($comp_data->result() as $company) {?>
                                        <option <?php if($expense_data[0]->company_id==$company->id){ echo 'selected'; } ?> value="<?php echo $company->id; ?>"><?php echo $company->name; ?></option>
                                    <?php  }
                                    ?>
                                </select>
                            </div>
							...
							<div class="col-md-2 fv-row">
								...
								<div class="position-relative d-flex align-items-center">
									...
									<!--end::Icon-->
									<!--begin::Datepicker-->
									<input class="form-control form-control-solid ps-12 datepicker" placeholder="Select a date" name="date" value="<?php echo date('d-m-Y',strtotime($expense_data[0]->date)); ?>"/>
									<!--end::Datepicker-->
								</div>
								<!--end::Input-->
							</div>
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Description" name="remarks" value="<?php echo $expense_data[0]->remarks; ?>"/>
                            </div>
                            <!--end::Col-->
							<!--begin::Col-->
							<div class="col-md-4 fv-row">
								<label class="required fs-6 fw-bold mb-2">Budget Line</label>
								<select class="form-select form-select-solid" data-control="select2" id="sub_category_change" data-hide-search="true" data-placeholder="Select Categories" name="sub_category_id">
									...
									foreach($all_sub_categories->result() as $sub_categories){
									    ?>
									    <option <?php if($expense_data[0]->sub_category==$sub_categories->id){ echo 'selected'; } ?> data-main_cat_id="<?php echo $sub_categories->main_cat_id; ?>" value="<?php echo $sub_categories->id; ?>"><?php echo $sub_categories->name; ?></option>
									    <?php
									}
									?>
								</select>
						...
						<div class="row g-3 mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select Cost Center" name="cost_center">
                                    ...
                                    foreach($all_cost_centers->result() as $cost_centers){
                                        ?>
                                        <option <?php if($expense_data[0]->cost_center==$cost_centers->id){ echo 'selected'; } ?>  value="<?php echo $cost_centers->id; ?>"><?php echo $cost_centers->name; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
							...
							<!--begin::Col-->
							<div class="col-md-4 fv-row">
								<label class="required fs-6 fw-bold mb-2">Vendor/Supplier</label>
								<select class="form-select form-select-solid" data-control="select2" data-placeholder="Vendor/Supplier" name="supplier_id">
									...
									foreach($all_suppliers->result() as $suppliers){
									    ?>
									    <option <?php if($expense_data[0]->supplier_id==$suppliers->id){ echo 'selected'; } ?> value="<?php echo $suppliers->id; ?>"><?php echo $suppliers->name; ?></option>
									    <?php
									}
									?>
								</select>
						...
						<div class="row g-3 mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Supplier Ref No" name="supplier_ref" value="<?php echo $expense_data[0]->supplier_ref; ?>"/>
                            </div>
                            <!--end::Col-->
							<!--begin::Col-->
							<div class="col-md-2 fv-row">
								<label class="required fs-6 fw-bold mb-2"> Amount </label>
								<input type="text" class="form-control form-control-solid" placeholder="Amount" id="current_expense_amount" name="amount" value="<?php echo round($expense_data[0]->initial_amount,2); ?>"/>
                                <input type="hidden" name="exp_amount" id="exp_amount" value=""/>

                            </div>
                            <div class="col-md-2 fv-row">
                                <label class="required fs-6 fw-bold mb-2">Currency</label>
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Currency" id="currency" name="currency">
                                    <option value="">Select Currency...</option>
                                    <?php
                                    foreach($currency_data->result() as $currency){
                                        ?>
                                        <option <?php if($expense_data[0]->currency==$currency->code){ echo 'selected'; } ?> value="<?php echo $currency->code; ?>"><?php echo $currency->code; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
							...
							<!--end::Col-->
                            <div class="col-md-4 fv-row">
                                <label class="required fs-6 fw-bold mb-2">Tax</label>
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select Tax" id="tax" name="tax">
                                    ...
                                    foreach($tax_data->result() as $tax) {?>
                                        <option  <?php if($expense_data[0]->tax_code==$tax->tax_code) { echo 'selected'; } ?>  value="<?php echo $tax->tax_code?>"><?php echo $tax->tax_code."   -  ".$tax->name?></option>
                                    <?php  }
                                    ?>
                                </select>
                            </div>
							<!--begin::Col-->
							<div class="col-md-2 fv-row">
								<label class="fs-6 fw-bold mb-2">  Budget Run.Tot  </label>
							...
							<!--begin::Col-->
							<div class="col-md-2 fv-row">
								<label class="fs-6 fw-bold mb-2">  Running Total  </label>
							...
							<!--begin::Col-->
							<div class="col-md-4 fv-row">
								<label class="fs-6 fw-bold mb-2">  Available Budget  </label>
								<input type="text" class="form-control form-control-solid" id="total_available_budget" style="color: green; font-size: 16px; font-weight: bold;"/>
							</div>
							<!--end::Col-->
							...
							<div class="col-md-4 fv-row">
                                ...
                                <?php
								if(!empty($expense_data[0]->file)){
								    ?>
								    <input type="hidden" name="expense_file_name" value="<?php echo $expense_data[0]->file; ?>"/>
									<a class="symbol symbol-20px mb-5" target="blank" href="<?php echo site_url('uploads/expense_files/'.$expense_data[0]->file); ?>"><i class="fa fa-file"></i> View Uploaded Document</a>
									<?php
								}
								?>
							</div>
						...
						<div class="d-flex flex-column mb-8">
							...
							<textarea class="form-control form-control-solid" rows="3" name="expense_description" placeholder="Free field to describe the description of the expense"><?php echo $expense_data[0]->description; ?></textarea>
						</div>
						<!--end::Input group-->
						<!--begin::Actions-->
