		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
					...
					<!--end::Nav-->
					<!--begin::Form-->
					<form class="mx-auto mw-1000px w-100 pt-0 pb-10" id="kt_create_account_form">
						<!--begin::Step 1-->
						<div class="current" data-kt-stepper-element="content">
						    <input type="hidden" name="budget_id" value="<?php echo $budget_details_info[0]->id; ?>"/>
							<!--begin::Wrapper-->
							<div class="w-100">
								<!--begin::Heading-->
								...
								<div class="fv-row">
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <!--begin::Label-->
											...
											<!--end::Label-->
											<input type="text" class="form-control form-control-solid" placeholder="Budget Name" id="budget_name" name="budget_name" required="true" value="<?php echo $budget_details_info[0]->budget_name; ?>"/>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select name="currency" class="form-select form-select-lg form-select-solid" data-placeholder="Select Currency" data-allow-clear="true" data-hide-search="true">
                                                ...
                                                foreach($currency_data->result() as $currencies) {?>
                                                    <option value="<?php echo $currencies->code?>"<?php if($budget_details_info[0]->currency==$currencies->code) echo 'selected';?>><?php echo $currencies->code?></option>
									...
									<div class="row g-3 mb-5">
										...
										<div class="col-md-6 fv-row">
											...
											<div class="position-relative d-flex align-items-center">
												...
												<!--end::Icon-->
												<!--begin::Datepicker-->
												<input class="form-control form-control-solid ps-12 datepicker" placeholder="Start Date" name="start_date" id="budget_start_date" value="<?php echo date('d-m-Y',strtotime($budget_details_info[0]->date_from)); ?>"/>
												<!--end::Datepicker-->
											</div>
											<!--end::Input-->
										</div>
										...
										<div class="col-md-6 fv-row">
											...
											<div class="position-relative d-flex align-items-center">
												...
												<!--end::Icon-->
												<!--begin::Datepicker-->
												<input class="form-control form-control-solid ps-12 datepicker" placeholder="End Date" name="end_date"  id="budget_end_date" value="<?php echo date('d-m-Y',strtotime($budget_details_info[0]->date_to)); ?>"/>
												<!--end::Datepicker-->
											</div>
										</div>
										<!--end::Col-->
										...
										<div class="" data-kt-ecommerce-catalog-add-product="auto-options" data-select2-id="select2-data-135-iq88">
											...
											<div id="kt_ecommerce_add_product_options" data-select2-id="select2-data-kt_ecommerce_add_product_options">
                            									...
                            									<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            										...
                            										<div class="d-flex flex-column">
                            											...
                            											<div class="d-flex align-items-center mb-1">
                            												<a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3" id="budget_display_name"><?php echo $budget_details_info[0]->budget_name; ?></a>
                            												<span class="badge badge-light-success me-auto">In Progress</span>
                            											</div>
                            											<!--end::Status-->
                            											<!--begin::Description-->
                            											<div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400" id="budget_display_description"><?php echo date('d-m-Y',strtotime($budget_details_info[0]->date_from)).' - '.date('d-m-Y',strtotime($budget_details_info[0]->date_to)); ?></div>
                            											<!--end::Description-->
                            										</div>
                            										<!--end::Details-->
                            									</div>
                            									...
                            									<div class="d-flex flex-wrap align-middle">
                            										...
                            										<div class="d-flex flex-wrap">
                            											...
                            											<div class="border border-primary border-solid rounded min-w-125px py-3 px-4 me-6 mb-3">
                            												<!--begin::Number-->
                            												<div class="text-end">
                            													<div class="text-end fs-4 fw-bolder text-primar" id="g_total_budget_amount">0.00</div>
                            								...
                            								<table class="table table-row-dashed table-row-gray-300 align-middle">
                            									...
                            									<tbody id="category_approved_butget_list_table_body">
                            										<tr>
                            											...
                            											<td class="text-end">
                            												<a href="#" class="text-end text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"></a>
                            											</td>
                            										</tr>
                            									</tbody>
                            									...
                            									<tr class="px-3">
                            										...
                            										<td class="text-end fw-bolder text-primary fs-4" id="budget_cat_list_table_total">0.00</td>
                            									</tr>
                            									</tfoot>
                            								</table>
                            							</div>
											 ...
											 ?>
                    									...
                    									<div class="card badge-light border">
                    										...
                    										<div class="card-header">
                    											...
                    											<div class="card-title fs-3 fw-bolder"> 
                        											...
                        											<div class="w-200 w-md-400px">
        																<select name="main_category[]" class="form-solid form-select-lg form-select-solid select_main_cat_dropdown_list" data-placeholder="Select Categories" data-allow-clear="true" data-hide-search="true">
        																	...
        																	foreach($all_categories->result() as $categories){
        																	    ?>
        																	    <option <?php if($assigned_budget_category_data->category_id==$categories->id){ echo 'selected'; } ?> value="<?php echo $categories->id; ?>"><?php echo $categories->name; ?></option>
        																	    <?php
        																	}
        																	?>
        																</select>
                    											...
                    											<div class="card-toolbar">
                    												<div class="border border-success border-solid rounded min-w-125px py-2 px-4 ms-6">
                    													<div class="fw-bold fs-6 text-gray-400"></div>
                    													<!--begin::Number-->
                    													<input type="hidden" name="main_category_budget[]" class="text-end main_assigned_budget" value="0">
                    													<div class="d-flex align-items-center">
                    														<div class="text-end fs-6 fw-bolder text-success">Total Budget: <span class="category_div_main_total_span">0.00</span></div>
                    													</div>
                    													<!--end::Number-->
                    												</div>
                    											</div>
                    										...
                    										<div class="card-body bg-white sub_category_listing_div">
                    											<?php
                    										    $main_cat_id = $assigned_budget_category_data->category_id;
                    										    ?>
                                                                    			...
                                                                    			<div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center gap-5" data-select2-id="select2-data-132-a5tz">
                                                                    				...
                                                                    				<div class="w-200 w-md-400px">
                                                                    					...
                                                                    					foreach($sub_cat_data->result() as $sub_categories){
                                                                    					    ?>
                                                                    					    <option <?php if($sub_cat_assign_data->sub_category_id==$sub_categories->id){ echo 'selected'; } ?> value="<?php echo $sub_categories->id; ?>"><?php echo $sub_categories->name; ?></option>
                                                                    					    <?php
                                                                    					}
                                                                    					?>
                                                                    					</select>
                                                                    				...
                                                                    				<!--begin::Input-->
                                                                    				<input type="number" data-main_cat_id="<?php echo $main_cat_id; ?>" class="text-end form-control mw-100 w-200px sub_category_budget_keyup" name="sub_cat_amount[<?php echo $main_cat_id; ?>][]" placeholder="Budget" value="<?php echo round($sub_cat_assign_data->amount,2); ?>">
                                                                    				<!--end::Input-->
												...
												<!--end::Form group-->
												<input type="hidden" id="main_category_list_div_html" value="
											    <!--begin::Input group-->
                    							<div class=&quot;mb-10 fv-row&quot;>
                    								<div class=&quot;card-body p-0&quot; data-select2-id=&quot;select2-data-136-vp2d&quot;>
                    									<!--begin::Card-->
                    										...
                    										<div class=&quot;card-header&quot;>
                    											...
                    											<div class=&quot;card-title fs-3 fw-bolder&quot;> 
                        											...
                        											<div class=&quot;w-200 w-md-400px&quot;>
        																<select name=&quot;main_category[]&quot; class=&quot;form-select form-select-lg form-select-solid select_main_cat_dropdown_list&quot; data-placeholder=&quot;Select Categories&quot; data-allow-clear=&quot;true&quot; data-hide-search=&quot;true&quot;>
        																	...
        																	<?php
        																	foreach($all_categories->result() as $categories){
        																	    ?><option value=&quot;<?php echo $categories->id; ?>&quot;><?php echo $categories->name; ?></option><?php
        																	}
        																	?>
        																</select>
        																<!--end::Input-->
                    											...
                    											<div class=&quot;card-toolbar&quot;>
                    												<div class=&quot;border border-success border-solid rounded min-w-125px py-3 px-4 ms-6&quot;>
                    													...
                    													<input type=&quot;hidden&quot; name=&quot;main_category_budget[]&quot; class=&quot;text-end main_assigned_budget&quot; value=&quot;0&quot;>
                    													<div class=&quot;d-flex align-items-center&quot;>
                    														<div class=&quot;text-end fs-6 fw-bolder text-success&quot;>Total Budget: <span class=&quot;text-end category_div_main_total_span&quot;>0.00</span></div>
                    													</div>
                    													<!--end::Number-->
                    												</div>
                    											</div>
