<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Budget Allocation</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
    </div>
                                    ...
                                    <table class="table table-row-bordered">
                                        ...
                                        {//print_r($sub_cat_assign_data);
                                            ...
                                            if(isset($sub_category_name[0]->name)){
                                               ...
                                               <?php
                                               $budget_allocation=$this->Budgeting_model->get_budget_assigned_employees($budget_id,$sub_cat_assign_data->sub_category_id);
                                               foreach($budget_allocation as $budget_all){
                                        
                        
                                                 $employees=$this->Xin_model->get_employees_by_id($budget_all->employee_id);
                                                
                                                 foreach($employees->result() as $e){
                                                    
                                                    ?><tr>
                                                          <td class="d-flex align-items-center pt-3"><i class="fa fa-user"> </i>  <?php echo  $e->first_name." ".$e->last_name; ?></td> 
                                                          <td class="fs-5 pt-3 text-dark fw-boldest text-end"><?php echo number_format($budget_all->amount); ?></td>
