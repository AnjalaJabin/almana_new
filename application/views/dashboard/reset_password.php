...
*/
    ...
    <title>Reset Password | Corbuz - A new Style for your business.</title>
</head>
<body>
<div class="container">
    <div class="row main">
        <div class="panel-heading">
            <div class="panel-title text-center">
                <a href="../"><img src="./uploads/logo/corbuz-logo2-white.png" alt="" class="responsive-img valign profile-image-login" style="max-width:250px;"></a>
                <p class="center login-form-text">&nbsp;</p>
            </div>
        </div>
        <div class="main-login main-center">

            <h2 align="center" class="center login-form-text">Reset Password</h2>
            <form class="form-material" action="<?php echo site_url('forgot_password/update_new_password/');?>" method="post" name="xin-form" id="xin-form">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="ixpassw1" id="ipass"  placeholder="Enter new password" required/>
                ...
                <div class="form-group">
                    <label for="name" class="cols-sm-2 control-label">Confirm New Password</label>
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock fa" aria-hidden="true"></i></span>
                            <input type="password" class="form-control" name="ixpassw2" id="ipass2"  placeholder="Confirm new password" required/>
                        </div>
                    </div>
                </div>

                <div class="form-group ">
                    <button type="submit" class="save btn btn-warning btn-lg btn-block login-button" name="registerForm">Reset Now</button>
                </div>
            ...
            $.ajax({
                ...
                success: function (JSON) {
                    if (JSON.error != '') {
                        ...
                        $('#ipass').val(''); // To reset form fields
                        $('#ipass2').val(''); // To reset form fields
                        $('.save').prop('disabled', false);
                    }
                }
            });
