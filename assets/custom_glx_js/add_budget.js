$(document).ready(function() {
    ...
    $('#main_category_list_div_html').val($('#all_main_cat_list_div').html());
    ...
    function calculate_allocated_balance(){
        ...
        $('.select_main_cat_dropdown_list').each(function(){
            ...
            $('#category_approved_butget_list_table_body').append('<tr><td>'+selected_cat_name+'</td><td>'+addCommas(cat_tot_amount)+'</td></tr>');
        });
    }
